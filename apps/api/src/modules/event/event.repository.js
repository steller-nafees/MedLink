...
const getAllEvents = async ({ limit, offset, userId, isAdmin }) => {
...
const getEventById = async ({ eventId, userId, isAdmin }) => {
    ...
    const hospitalsResult = await pool.query(`
        ...
        INNER JOIN hospitals h ON h.id = eh.hospital_id
    ...
    const ambulancesResult = await pool.query(`
        ...
        INNER JOIN ambulance_providers ap ON ap.id = ea.ambulance_provider_id
