...
type Personal = typeof profileMock.personal;
...
export default function PatientProfileScreen() {
  ...
  const donationEligibility = eligibilityFrom(profileMock.donation.lastDonation);
    ...
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingTop: insets.top + 16, paddingBottom: insets.bottom + 128 }]} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.profileCard}>
          <View style={styles.avatar}><Text style={styles.avatarText}>{profileMock.initials}</Text></View>
          <View style={styles.identity}><Text style={styles.name}>{personal.fullName}</Text><Text style={styles.identityDetail}>{profileMock.email}</Text><Text style={styles.identityDetail}>{profileMock.phone}</Text></View>
        ...
        <View style={styles.card}>
          <View style={styles.bloodTop}><View style={styles.bloodGroup}><Text style={styles.bloodGroupText}>{profileMock.donation.group}</Text></View><View style={styles.flex}><Text style={styles.overline}>Blood group</Text><Text style={styles.bloodValue}>{profileMock.donation.group}</Text></View><View style={styles.eligibility}><Text style={styles.eligibilityText}>{donationEligibility.label}</Text></View></View>
          <View style={styles.dividerRow}><View><Text style={styles.rowTitle}>Last donation</Text><Text style={styles.rowCopy}>{formatDate(profileMock.donation.lastDonation)}</Text></View><View style={styles.ready}><Text style={styles.readyText}>{donationEligibility.eligible ? "Ready" : `${donationEligibility.daysLeft} days left`}</Text></View></View>
