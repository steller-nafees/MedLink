...
export function GuestSosModal({ onClose, onSubmit }: { onClose: () => void; onSubmit?: () => void }) {
  ...
  const activate = () => {
    // Usually we would navigate with these query params, but we just trigger the layout's onSubmit here
    // since the routing differs a bit in this project setup.
